...
$( "footer.footer.py-3.py-lg-4.py-xl-5 > .container" ).append("<div class='row'><div class='div.col-12.col-lg-auto.order-lg-last'>"
...
//Fim
$('<div class="rastrear-pedido"></div>').appendTo('div.col-12.col-lg-auto.order-lg-last');
